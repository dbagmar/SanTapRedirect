...
public extension KeyboardButton {
    ...
    func animateStandardRelease(completion: (() -> Void)? = nil) {
        animateTransform2(.identity, completion: completion)
    }
...
private extension KeyboardButton {
    ...
    func animateTransform(_ transform: CGAffineTransform, completion: (() -> Void)? = nil) {
        UIView.animate(
            ...
            animations: {
//                [weak self] in self?.transform = transform
//                self.backgroundColor = UIColor(named: "darkButton")
    ...
    func animateTransform2(_ transform: CGAffineTransform, completion: (() -> Void)? = nil) {
            UIView.animate(
                withDuration: 0.1,
                delay: 0,
                options: [.curveEaseOut, .allowUserInteraction],
