...
//  KeyboardKit
//
//  Created by Pranjal Lamba on 05/02/20.
//
 ...
 */
public class AmountToolbar: KeyboardToolbar {
    ...
    public convenience init(
        ...
        self.init(
            height: height,
            buttonCreator: { AmountToolbarLabel(text: $0, textDocumentProxy: textDocumentProxy) },
            alignment: alignment,
