...
internal enum Asset {
  internal enum Colors {
    internal static let shiftButton = ColorAsset(name: "shiftButton")
...
//    internal static let darkSystemButtonText = ColorAsset(name: "darkSystemButtonText")
    internal static let darkButton = ColorAsset(name: "lightButton")
    internal static let darkButtonText = ColorAsset(name: "lightButtonText")
    internal static let darkSystemButton = ColorAsset(name: "lightSystemButton")
    internal static let darkSystemButtonText = ColorAsset(name: "lightSystemButtonText")
  ...
  internal enum Images {
    internal enum Buttons {
      internal static let backspace = ImageAsset(name: "Buttons/stap_backspace")
      internal static let newline = ImageAsset(name: "Buttons/stap_newline")
      internal static let space = ImageAsset(name: "Buttons/stap_space")
      internal static let switchKeyboard = ImageAsset(name: "Buttons/stap_switchKeyboard")
    }
  }
}
