...
- (void)configureAppearance
{
    ...
    for (NSInteger i = 0; i < self.weekdayPointers.count; i++) {
        ...
        [label setFont:[UIFont fontWithName:@"SantanderText-Regular" size:18]];
        label.textColor = [UIColor blackColor];//self.calendar.appearance.weekdayTextColor;
        //change spainsh week name.
        NSString *weekdays = [[NSString alloc] initWithString: useDefaultWeekdayCase ? weekdaySymbols[index] : [weekdaySymbols[index] uppercaseString]];
