...
- (void)configureCell:(FSCalendarHeaderCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.textColor = [UIColor colorWithRed:138/255.f green:138/255.f blue:138/255.f alpha:1.00];//[UIColor darkTextColor];//appearance.headerTitleColor;
    [cell.titleLabel setFont:[UIFont fontWithName:@"SantanderText-Bold" size:22]];
   ...
   // cell.titleLabel.text = text;
    ...
    NSLog(@"%@",text);
           ...
           void (^selectedCase)() = @{
               @"January" : ^{
                   cell.titleLabel.text =  [@"Enero" uppercaseString];
               },
               @"February" : ^{
                  cell.titleLabel.text =  [@"Febrero" uppercaseString];
               },
               @"March" : ^{
                   cell.titleLabel.text =  [@"Marzo" uppercaseString];
               },
               @"April" : ^{
                   cell.titleLabel.text =  [@"Abril" uppercaseString];
               },
               @"May" : ^{
                   cell.titleLabel.text = [@"Mayo" uppercaseString];
               },
               @"June" : ^{
                   cell.titleLabel.text =  [@"Junio" uppercaseString];
               },
               @"July" : ^{
                   cell.titleLabel.text = [@"Julio" uppercaseString];
               },
               @"August" : ^{
                    cell.titleLabel.text =  [@"Agosto" uppercaseString];
                },
               @"September" : ^{
                    cell.titleLabel.text =  [@"Septiembre" uppercaseString];
                    },
               @"October" : ^{
                    cell.titleLabel.text =  [@"Octubre" uppercaseString];
                    },
               @"November" : ^{
                    cell.titleLabel.text =  [@"Noviembre" uppercaseString];
                    },
               @"December" : ^{
                   cell.titleLabel.text =  [@"Diciembre" uppercaseString];
               },
           }[text];
