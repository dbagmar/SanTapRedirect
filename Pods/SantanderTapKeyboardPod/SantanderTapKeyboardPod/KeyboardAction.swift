...
public extension KeyboardAction {
    ...
    var getImageDescription: String {
        switch self {
        case .image(description: "app", keyboardImageName: "stap_app", imageName: "stap_app"): return "app"
        case .image(description: "appRed", keyboardImageName: "stap_appRed", imageName: "stap_appRed"): return "appRed"
        case .image(description: "pagar", keyboardImageName: "stap_pagar", imageName: "stap_pagar"): return "pagar"
        case .image(description: "servicios", keyboardImageName: "stap_servicios", imageName: "stap_servicios"): return "servicios"
        case .image(description: "servicios", keyboardImageName: "stap_Servicess", imageName: "stap_Servicess"): return "servicios"
        case .image(description: "atm", keyboardImageName: "stap_atm", imageName: "stap_atm"): return "atm"
        case .image(description: "atm", keyboardImageName: "stap_ATMs", imageName: "stap_ATMs"): return "atm"
        case .image(description: "enviarUnselected", keyboardImageName: "stap_enviarUnselected", imageName: "stap_enviarUnselected"): return "enviarUnselected"
        case .image(description: "enviarSelected", keyboardImageName: "stap_enviarSelected", imageName: "stap_enviarSelected"): return "enviarSelected"
        case .image(description: "BackArrow", keyboardImageName: "stap_BackArrow", imageName: "stap_BackArrow"): return "BackArrow"
        case .image(description: "BackArrowCircle", keyboardImageName: "stap_BackArrowCircle", imageName: "stap_BackArrowCircle"): return "BackArrowCircle"
        case .image(description: "Keyboard", keyboardImageName: "stap_Keyboard", imageName: "stap_Keyboard"): return "Keyboard"
         case .image(description: "KeyboardWork", keyboardImageName: "stap_Keyboard", imageName: "stap_Keyboard"): return "KeyboardWork"
        default: return ""
        }
    }
