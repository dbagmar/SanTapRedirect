...
open class ToastAlert: KeyboardAlert {
    ...
    public struct Appearance {
       ...
       // public var font: UIFont = UIFont(name: "stap_SantanderText-Regular", size: 12.0)!
...
private extension ToastAlert {
    ...
    func createContainerView(for label: Label,button: Button ,in view: UIView) -> View {
        let container = View(frame: CGRect(x: 5, y: 10, width: UIScreen.main.bounds.size.width - 10, height: 260))
       ...
       // container.frame.origin.y += appearance.verticalOffset
        ...
        alertLabel.center = CGPoint(x: view.frame.size.width/2, y:80)
       ...
       buttons.center = CGPoint(x: view.frame.size.width/2, y:180)
        buttons.titleLabel?.font = UIFont(name: "SantanderText-Regular", size: 14)
       ...
       buttons.addTapAction {
            ...
            self.unpresent(container, withDuration: 0)
   ...
   @objc func buttonClicked() {
    ...
    func createLabel(withText text: String) -> Label {
        ...
        label.font =  UIFont(name: "SantanderText-Regular", size: 14)
